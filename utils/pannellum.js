...
export function pannellum (window, document, undefined) {

  var window = wx.createSelectorQuery().select('window') || window
  var document = wx.createSelectorQuery().select('document') || document
